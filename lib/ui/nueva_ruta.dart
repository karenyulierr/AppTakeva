...
class _NuevaRutaState extends State<NuevaRuta> {
        ...
        appBar: AppBar(
          title: Text(
            "Ruta " +
                ...
                ": " +
                widget.list[widget.index]['idBarrioInicia'].toString() +
                " - " +
                widget.list[widget.index]['idBarrioTermina'].toString(),
          ),
  ...
  void setPolylines() async {
    List<PointLatLng> pathLines = polylinePoints
        ?.decodePolyline(widget.list[widget.index]['recorridoRuta']);
